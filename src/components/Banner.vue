<template>
    ...
    <img src="../assets/imagens/foto-banner.png" alt="Foto de uma mulher cozinhando com uma bacia de vidro nas mãos. Ela está sorrindo e esta apoiando um celular entre seu rosto e ombro." class="foto-banner">
